...
function checkBizID()  //사업자등록번호 체크 
{ 
	ThisVal1=document.myform.permitNumber1.value ; //번호 첫번째
	ThisVal2=document.myform.permitNumber2.value ; //번호 두번째
	ThisVal3=document.myform.permitNumber3.value ; //번호 세번째
			...
			<table border="1" cellPadding="0" cellSpacing="3">
				...
				<tr>
					...
					<td><input type="text" maxlength="3" size="3"
						...
						type="button" value="사업자 확인" onClick="return checkBizID();"></td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="jumin1" maxlength="6" size="6"
						...
						type="button" value="중복확인" onClick="jumin_Check()"></td>
				</tr>
